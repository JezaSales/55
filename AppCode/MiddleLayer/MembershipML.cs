...
namespace RoundpayFinTech.AppCode.MiddleLayer
{
    public class MembershipML: IMembershipML
    {
        ...
        public IResponseStatus ChangeMemberShipStatus(int ID,string type)
        {
        ...
        public PackageDetailB2CWithMemberShip GetB2CMemberShipType(int LoginID) {
            IProcedure proc = new ProcGetB2CMemberTypeByMember(_dal);
              return (PackageDetailB2CWithMemberShip)proc.Call(LoginID);
        }

        public async Task<IEnumerable<B2cTarget>> GetB2cTargetAchieved(CommonReq commonReq)
        {
            var targetAchieved = new List<B2cTarget>();
            IProcedureAsync proc = new ProcGetb2cTargetAchievedTillDate(_dal);
            targetAchieved = (List<B2cTarget>)await proc.Call(commonReq);
