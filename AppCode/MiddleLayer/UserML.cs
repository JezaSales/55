...
namespace RoundpayFinTech.AppCode
{
    ...
    public class UserML : IUserML, IFundProcessML, IKYCML, IAdminML, IUserAPPML, IAPIUserML, IIPAddressML, IUserWebsite
    {
        ...
        public IEnumerable<IPAddressModel> GetIPAddress(string MobileNo, int ID)
        {
            ...
            if (_lr.LoginTypeID == LoginType.ApplicationUser && _lr.RoleID.In(Role.Admin, Role.APIUser) || _lr.IsWLAPIAllowed && ApplicationSetting.IsWLAPIAllowed)
            {
        ...
        public IResponseStatus UpdateChangeIntro(int UserID, string IntroMob, int LoginId, int LoginTypeId)
        {
            var res = new ResponseStatus
            {
                Statuscode = ErrorCodes.Minus1,
            ...
            if (!Validate.O.IsMobile(IntroMob))
            {
                res.Msg = "Wrong Introducer Mobile Number.";
                return res;
            }
            if ((LoginTypeId == LoginType.ApplicationUser && !IsEndUser()) || IsCustomerCareAuthorised(ActionCodes.AddEditSLAB))
            {
                ...
                IProcedure proc = new ProcChangeIntroOfGivenUser(_dal);
                res = (ResponseStatus)proc.Call(req);
            }
            return res;
        }
        ...
        public IResponseStatus ChangeOTPStatus(int UserID, int type, bool Is)
        {
            ...
            if ((_lr.LoginTypeID == LoginType.ApplicationUser) || IsCustomerCareAuthorised(ActionCodes.ChangeOTPStatus) || IsCustomerCareAuthorised(ActionCodes.ChangeUserStatus) || _lr.IsWLAPIAllowed && ApplicationSetting.IsWLAPIAllowed)
            {
        ...
        public UserRoleSlab GetRoleSlabforB2cTarget()
        {
            var UserID = _lr.LoginTypeID == LoginType.CustomerCare ? 1 : _lr.UserID;
            IProcedure proc = new ProcUserSelectRoleSlabB2cTarget(_dal);
            return (UserRoleSlab)proc.Call(UserID);
        }
        ...
        public UserList GetList(CommonFilter _filter)
        {
            ...
            if ((_filter.LT == LoginType.ApplicationUser && !IsEndUser()) || IsCustomerCareAuthorised(ActionCodes.ShowUser) || _lr.IsWLAPIAllowed && ApplicationSetting.IsWLAPIAllowed)
            {
                var validate = Validate.O;
                var _req = new UserRequest
                {
                ...
                if (_filter.LT == LoginType.ApplicationUser && !IsEndUser() || IsCustomerCareAuthorised(ActionCodes.ShowUser) || _lr.IsWLAPIAllowed && ApplicationSetting.IsWLAPIAllowed)
                {
                    _resp.CanChangeOTPStatus = (_filter.LoginRoleID == Role.Admin && _filter.LT == LoginType.ApplicationUser) || IsCustomerCareAuthorised(ActionCodes.ChangeOTPStatus) || _lr.IsWLAPIAllowed && ApplicationSetting.IsWLAPIAllowed;
                    ...
                    _resp.CanEdit = _filter.LT == LoginType.ApplicationUser || IsCustomerCareAuthorised(ActionCodes.EditUser) || _lr.IsWLAPIAllowed && ApplicationSetting.IsWLAPIAllowed;
                    ...
                    _resp.CanChangeRole = (_filter.LoginRoleID != Role.Distributor && _filter.LT == LoginType.ApplicationUser) || IsCustomerCareAuthorised(ActionCodes.AddEditSLAB);
        ...
        public BulkSmsEmail GetBulkSms()
        {
            ...
            if (_lr.LoginTypeID == LoginType.ApplicationUser && _lr.RoleID == Role.Admin || IsCustomerCareAuthorised(ActionCodes.BulkEmail) || IsCustomerCareAuthorised(ActionCodes.BulkSMS) || _lr.IsWLAPIAllowed && ApplicationSetting.IsWLAPIAllowed)
            {
                var UserID = _lr.LoginTypeID == LoginType.CustomerCare ? 1 : _lr.UserID;
                IProcedure proc = new SelectRole(_dal);
        ...
        public async Task<ResponseStatus> CallBankTransfer(BankServiceReq bankServiceReq)
        {
            ...
            if (res.Statuscode == ErrorCodes.One)
            {
                ...
                else if (res.APICode.Equals(APICode.CASHFREE))
                {
                    var tAPIRequest = new MTAPIRequest
                    {
                        APIID = res.APIID,
                        ...
                        Address = res.Address,
                        Pincode = Convert.ToInt32(res.Pincode)
                    };
                    IMoneyTransferAPIML moneyTransferAPIML = new CashFreePayoutML(_accessor, _env, _dal, APICode.CASHFREE);
                    APIRes = moneyTransferAPIML.AccountTransfer(tAPIRequest);
                }
                else if (res.APICode.Equals(APICode.INSTANTPayDirect))
                {
                    var tAPIRequest = new MTAPIRequest
                    {
                        APIID = res.APIID,
                    ...
                    IMoneyTransferAPIML moneyTransferAPIML =  new IPayPayoutDirectML(_accessor, _env, _dal, APICode.INSTANTPayDirect, res.APIID, res.APIGroupCode);
                    APIRes = moneyTransferAPIML.AccountTransfer(tAPIRequest);
                }
                else if (res.APICode.Equals(APICode.DIKSHUPay))
                {
                    var tAPIRequest = new MTAPIRequest
                    {
                        APIID = res.APIID,
                    ...
                    IMoneyTransferAPIML moneyTransferAPIML = new DIKSHUPayML(_accessor, _env, _dal, APICode.DIKSHUPay, res.APIID, res.APIGroupCode);
                    APIRes = moneyTransferAPIML.AccountTransfer(tAPIRequest);
                }
            }
        ...
        public ResponseStatus DeleteUser(int LID, int UID)
        {
            ...
            string NewMob = "4" + HashEncryption.O.CreatePasswordNumeric(4) + UID.ToString().PadLeft(5, '0');
            IProcedure proc = new ProcDeleteUserFromUserList(_dal);
            _res = (ResponseStatus)proc.Call(new CommonReq{
                LoginID = LID,
                UserID = UID,
                CommonStr = NewMob
            });
        ...
        public UserList AppGetList(CommonFilter _filter)
        {
            ...
            if ((_filter.LT == LoginType.ApplicationUser && !IsEndUser()) || IsCustomerCareAuthorised(ActionCodes.ShowUser))
            {
                ...
                var _req = new UserRequest
                {
                    LoginID = ApplicationSetting.IsAccountStatement ? UserID : _filter.UserID,
                    SortByID = false,
        ...
        public GetAddService GetAddServiceSts(int LT, int userid, int outletID, int opTypeid = 0)
        {
        ...
        public IResponseStatus Generateb2cOtp(CommonReq commonreq)
        {
            ...
            IProcedure _proc = new ProcGenerateB2cOtp(_dal);
            _resp = (ResponseStatus)_proc.Call(commonreq);
            return _resp;
        }
