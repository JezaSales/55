...
namespace RoundpayFinTech.AppCode.MiddleLayer
{
    public class CoupanVoucherML : ICoupanVoucherML
    {
        ...
        public IEnumerable<CoupanVoucher> GetCouponVoucher(int Id, int loginId, int loginTypeId)
        {
            ...
            List<CoupanVoucher> resp = (List<CoupanVoucher>)_proc.Call(req);
            return resp ?? new List<CoupanVoucher>();
        }
        ...
        public async Task<IResponseStatus> UploadCouponExcelUPloda(CoupanVoucherEXlReq reqData)
        {
            ...
            {
                LoginTypeID = reqData.LoginTypeID,
                LoginID = reqData.UserID,
        ...
        public async Task<IEnumerable<CouponstockDetail>> GetCouponStock(CoupanVoucherReq req)
        {
            IProcedureAsync _proc = new ProcGetCouponStock(_dal);
            List<CouponstockDetail> resp = (List<CouponstockDetail>)await _proc.Call(req);
            return resp;
        }
        public IEnumerable<VStock> GetVoucherStock( string APIID)
        {
            var resp = new List<VStock>();
            if ((_lr.RoleID == Role.Admin || _lr.IsWebsite) && _lr.LoginTypeID == LoginType.ApplicationUser)
            {
                var req = new CoupanVoucher
                {
                ...
                IProcedure _proc = new ProcGetVoucherStock(_dal);
                resp = (List<VStock>)_proc.Call(req);
            }
            return resp;
        }
