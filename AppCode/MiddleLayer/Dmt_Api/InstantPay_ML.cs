...
namespace RoundpayFinTech.AppCode.MiddleLayer.Dmt_Api
{
    ...
    public partial class InstantPay_ML : IMoneyTransferAPIML
    {
        ...
        public DMRTransactionResponse VerifyAccount(MTAPIRequest request)
        {
            ...
            string _URL = apiSetting.VerificationURL;
            string response = string.Empty;
            try
            {
                ...
                if (!string.IsNullOrEmpty(response))
                {
                    if (response != null)
                    {
                        var apiResp = JsonConvert.DeserializeObject<IPVrfyResp>(response);
            ...
            res.Request = _URL  + " | " + JsonConvert.SerializeObject(header) + " | " + JsonConvert.SerializeObject(req);
        ...
        //        source = "ORDER",
        //    };
        //    string URL = apiSetting.StatusCheck;
        //    string response = string.Empty;
        //    try
        //    {
        //        response = AppWebRequest.O.PostJsonDataUsingHWRTLS(URL, req, header).Result;
        //        var ipaystsResp = JsonConvert.DeserializeObject<IPayStatusCheckExternalResponse>(response);
        //        if (ipaystsResp != null)
        //        {
