...
namespace RoundpayFinTech.AppCode.MiddleLayer
{
    public class JWTTokenAuth_ML
    {
        ...
        public string GenerateJwtToken(JWTReqUsers jWTReqUsers)
        {
            ...
            string tDuration = string.IsNullOrEmpty(Configuration["JWT:DurationInDays"]) ? "10" : Configuration["JWT:DurationInDays"];
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                Expires = DateTime.UtcNow.AddDays(Convert.ToDouble(tDuration)),
