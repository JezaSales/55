...
namespace RoundpayFinTech.AppCode.Model.ROffer
{
    ...
    #endregion
    #region PSHLRResponse
    public class PSHLRResponse
    {
        public int StatusCode { get; set; }
        public string Msg { get; set; }
    ...
    #endregion
    #region RNPRechObjPlan
    public class PSRechObj
    {
    ...
    {
        public string pType { get; set; }
        public List<PDetail> pDetails { get; set; }
    }
    #endregion
    #region RNPDTHObjPlan
    public class PSDTHPrice
    {
        public string monthly { get; set; }
        public string quarterly { get; set; }
        public string halfYearly { get; set; }
    ...
    public class PDTHDetial
    {
        public string packageName { get; set; }
        public PSDTHPrice price { get; set; }
        public string pDescription { get; set; }
        public int packageId { get; set; }
        public string pLangauge { get; set; }
        public int pCount { get; set; }
    ...
    public class PSDthDObj
    {
        public string pType { get; set; }
        public List<PDTHDetial> pDetials { get; set; }
    }
    public class PSDthObj
    { 
        public List<PSDthDObj> data { get; set; }
    }
    #endregion
    #endregion
