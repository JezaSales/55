...
namespace RoundpayFinTech.AppCode.Model.ProcModel
{
    public class Package_Cl
    {
        ...
        public bool IsPaidAdditional { get; set; }
    ...
    public class UserBalnace
    {
        ...
        public string PrepaidWalletName { get; set; }
        public string UtilityWalletName { get; set; }
        public string BankWalletName { get; set; }
        public string CardWalletName { get; set; }
        public string RegIDWalletName { get; set; }
        public string PackageWalletName { get; set; }
    }
