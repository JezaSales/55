...
namespace Fintech.AppCode.Model
{
    ...
    public class UserQRInfo
    {
        ...
        public List<UserSmartDetail> cashfreeSmartDetail { get; set; }
    ...
    public class UserInfo
    {
        ...
        public int UPIRequestModeID { get; set; }
    }
    ...
    public class B2CDisplay : SlabModel
    {
    ...
    public class MembershipmasterB2C
    {
        ...
        public int CouponValidityDays { get; set; }
        public decimal Cost { get; set; }
        public bool IsExpireSoon { get; set; }
        public List<SlabdetailServicewise> slabdetailServicewises { get; set; }
    }
    public class PackageDetailB2CWithMemberShip
    {
       
        public List<MembershipmasterB2C> membershipmasterB2Cs { get; set; }
    }
