...
namespace RoundpayFinTech.AppCode.Model.App
{
    ...
    public class B2cAppTargetRequest : AppSessionReq
    {
    ...
    public class AppResponse
    {
        ...
        public bool IsB2cMembershipRePurchase { get; set; }
    ...
    public class SmartCollectAppResponse : AppResponse
    {
        public SmartCollectViewModel smartCollect { get; set; }
    }
    ...
    public class TeamResponse : AppResponse
    {
        public IEnumerable<Team> Data { get; set; }
    }
    public class AffiliateResponse : BaseAPIResponse
    {
    ...
    public class AfVendorWithProduct : BaseAPIResponse
    {
        public IEnumerable<AfVenodrsWithItems> DataV { get; set; }
   
    }

    public class AfCategoryWithProduct : BaseAPIResponse
    {
        public List<AfCategoriesWithItems> Data { get; set; }
    }

    public class LevelResponse : AppResponse
    {
        public IEnumerable<Level> Data { get; set; }
    }
    ...
    public class WebMemberTypeModel : AppResponse
    {
        ...
        // public IEnumerable<SlabdetailServicewise> DetailsServiceWise { get; set; }
    }
    public class WebB2cTargetAchieved
    {
        public int Statuscode { get; set; }
        public string Msg { get; set; }
        public bool IsVersionValid { get; set; }
        public List<B2cTarget> B2cTargetAchieved { get; set; }
    }
    ...
    public class webB2cres : AppResponse
    {
        public bool IsHeavyRefresh { get; set; }
        public bool IsTakeCustomerNo { get; set; }
        public OperatorDetail OperatorDetail { get; set; }
        public OperatorParamModels OperatorOptional { get; set; }

    }
    public class AddServReq : AppSessionReq
    {
        public int OutletID { get; set; }
        public int OpTypeID { get; set; }
    }

    public class AfLinkRequest : AppSessionReq
    {
