...
namespace RoundpayFinTech.AppCode.Model
{
    ...
    public class CoupanVoucherRes
    {
        public IEnumerable<CoupanVoucher> CoupanVoucher { get; set; }
        public IEnumerable<CoupanMaster> CoupanMaster { get; set; }
        public int MasterVId { get; set; }
        public int TotalACoupn { get; set; }
    }
    ...
    public class CouponstockDetail
    {
