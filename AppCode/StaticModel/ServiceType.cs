namespace Fintech.AppCode.StaticModel
{
    public static class ServiceType
    {
        ...
        public const int IssuanceService = 53;
    }
    public static class ServiceCode
    {
        ...
        public const string IssuanceService = "ISSUE";
    }
    public static class PlanType
    {
        ...
        public const string VASFintechAPI = "VASFNTH";
        public const string ROFFERCoPlan = "ROFFERCoPlan"; // new api https://roffer.in/
    ...
    public static class DynamicWebsiteType {
        ...
        public const int StaticCorporate = 5;
    }
    ...
    public static class B2CDisplayCommissionType
    {
        public const int ServiceWise = 1;
        public const int OpTypewise = 2;
    }
