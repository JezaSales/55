...
namespace RoundpayFinTech.AppCode.ThirdParty.Fingpay
{
    public partial class FingpayML
    {
        ...
        private string BalanceCheckURL = "https://fingpayap.tapits.in/fpaepsservice/api/balanceInquiry/merchant/getBalance";
        private string WithDrawlURL = "https://fingpayap.tapits.in/fpaepsservice/api/cashWithdrawal/merchant/withdrawal";
        private string AdharPayURL = "https://fingpayap.tapits.in/fpaepsservice/api/aadhaarPay/merchant/pay";
        private string OnBoardingURL = "https://fingpayap.tapits.in/fpaepsweb/api/onboarding/merchant/creation/m1";
        private string StatusCheckURL = "https://fpma.tapits.in/fpcardwebservice/api/ma/statuscheck/cw";
        private string AEPSStatusCheckURL = "https://fingpayap.tapits.in/fpaepsweb/api/auth/merchantInfo/statusCheckV2/merchantLoginId/cashWithdrawal/v2";
        private string StatementURL = "https://fingpayap.tapits.in/fpaepsservice/api/miniStatement/merchant/statement";
        private string DepositURLGenerateOTP = "https://fingpayap.tapits.in/fpaepsservice/api/CashDeposit/merchant/generate/otp";
        private const string DepositURLGenerateOTP_UAT = "https://fpuat.tapits.in/fpaepsservice/api/CashDeposit/merchant/generate/otp";
        private string DepositURLValidateOTP = "https://fingpayap.tapits.in/fpaepsservice/api/CashDeposit/merchant/validate/otp";
        private string DepositURLTransaction = "https://fingpayap.tapits.in/fpaepsservice/api/CashDeposit/merchant/transaction";

        private readonly IDAL _dal;
        public FingpayML(IHostingEnvironment env, IDAL dal)
        {
            _env = env;
        ...
        private void ReadAppSetting()
        {
            try
            {
                BalanceCheckURL = string.IsNullOrEmpty(Configuration["SERVICESETTING:FINGPAY:BalanceCheckURL"]) ? BalanceCheckURL : Configuration["SERVICESETTING:FINGPAY:BalanceCheckURL"];
                WithDrawlURL = string.IsNullOrEmpty(Configuration["SERVICESETTING:FINGPAY:WithDrawlURL"]) ? WithDrawlURL : Configuration["SERVICESETTING:FINGPAY:WithDrawlURL"];
                AdharPayURL = string.IsNullOrEmpty(Configuration["SERVICESETTING:FINGPAY:AdharPayURL"]) ? AdharPayURL : Configuration["SERVICESETTING:FINGPAY:AdharPayURL"];
                OnBoardingURL = string.IsNullOrEmpty(Configuration["SERVICESETTING:FINGPAY:OnBoardingURL"]) ? OnBoardingURL : Configuration["SERVICESETTING:FINGPAY:OnBoardingURL"];
                StatusCheckURL = string.IsNullOrEmpty(Configuration["SERVICESETTING:FINGPAY:StatusCheckURL"]) ? StatusCheckURL : Configuration["SERVICESETTING:FINGPAY:StatusCheckURL"];
                AEPSStatusCheckURL = string.IsNullOrEmpty(Configuration["SERVICESETTING:FINGPAY:AEPSStatusCheckURL"]) ? AEPSStatusCheckURL : Configuration["SERVICESETTING:FINGPAY:AEPSStatusCheckURL"];
                StatementURL = string.IsNullOrEmpty(Configuration["SERVICESETTING:FINGPAY:StatementURL"]) ? StatementURL : Configuration["SERVICESETTING:FINGPAY:StatementURL"];
                DepositURLGenerateOTP = string.IsNullOrEmpty(Configuration["SERVICESETTING:FINGPAY:DepositURLGenerateOTP"]) ? DepositURLGenerateOTP : Configuration["SERVICESETTING:FINGPAY:DepositURLGenerateOTP"];
                DepositURLValidateOTP = string.IsNullOrEmpty(Configuration["SERVICESETTING:FINGPAY:DepositURLValidateOTP"]) ? DepositURLValidateOTP : Configuration["SERVICESETTING:FINGPAY:DepositURLValidateOTP"];
                DepositURLTransaction = string.IsNullOrEmpty(Configuration["SERVICESETTING:FINGPAY:DepositURLTransaction"]) ? DepositURLTransaction : Configuration["SERVICESETTING:FINGPAY:DepositURLTransaction"];
            }
            catch (Exception ex)
            {
        ...
        public OutletAPIStatusUpdate TwoFactorAuthentication(ValidateAPIOutletResp _ValidateAPIOutletResp, FingpayAPISetting FPSetting)
        {
            ...
            try
            {
                ...
                var req = new
                {
                    ...
                    requestRemarks = "For Twoway authentication",
                    transactionType = "AUO",
