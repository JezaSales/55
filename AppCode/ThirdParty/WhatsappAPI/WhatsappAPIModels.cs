...
namespace RoundpayFinTech.AppCode.ThirdParty.WhatsappAPI
{
    ...
    {
        public Wati Wati { get; set; }
        public Wateam Wateam { get; set; }
        public ThreeSixty ThreeSixty { get; set; }
    }
    public class Wati
    {
    ...
    public class WhatsappThreeSixtyResp
    {
        public List<Contact> contacts { get; set; }
        public List<Message> messages { get; set; }
    ...
    public class WhatsappThreeSixtyRespFailed
    {
        public Meta meta { get; set; }
    }
