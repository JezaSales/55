...
namespace RoundpayFinTech.AppCode.ThirdParty.AxisBank
{
    ...
    public class AxisBankICollectReq
    {
        public string UTR { get; set; }
        public string Bene_acc_no { get; set; }
        public string Req_type { get; set; }
        public string Req_dt_time { get; set; }
        public string Txn_amnt { get; set; }
        public string Pmode { get; set; }
        public string Sndr_acnt { get; set; }
        public string Sndr_nm { get; set; }
        public string Sndr_acnt1 { get; set; }
        public string Sndr_nm1 { get; set; }
        public string Sndr_Ifsc { get; set; }
        public string Corp_code { get; set; }
        public string Tran_id { get; set; }
    }
    public class AxixBankICollectResp
    {
        [JsonProperty("Stts_flg")]
        public string Stts_flg { get; set; }
        [JsonProperty("Err_cd")]
