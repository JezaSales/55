...
namespace RoundpayFinTech.AppCode.DL
{
    public class ProcGetSender : IProcedure
    {
        ...
        public object Call(object obj)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    res.Statename = dt.Rows[0]["StateName"] is DBNull ? "" : dt.Rows[0]["StateName"].ToString();
        ...
        {
            return "select s.*,ms.StateName from tbl_Sender s inner join MASTER_STATE ms on s._StateID=ms._ID where _MobileNo=@MobileNo";
        }
    }
}
