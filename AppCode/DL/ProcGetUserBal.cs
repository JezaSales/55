        ...
        public object Call(object obj)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    _res.PrepaidWalletName = dt.Rows[0]["_PrepaidWalletName"] is DBNull ? string.Empty : dt.Rows[0]["_PrepaidWalletName"].ToString();
                    _res.UtilityWalletName = dt.Rows[0]["_UtilityWalletName"] is DBNull ? string.Empty : dt.Rows[0]["_UtilityWalletName"].ToString();
                    _res.BankWalletName = dt.Rows[0]["_BankWalletName"] is DBNull ? string.Empty : dt.Rows[0]["_BankWalletName"].ToString();
                    _res.CardWalletName = dt.Rows[0]["_CardWalletName"] is DBNull ? string.Empty : dt.Rows[0]["_CardWalletName"].ToString();
                    _res.RegIDWalletName = dt.Rows[0]["_RegIDWalletName"] is DBNull ? string.Empty : dt.Rows[0]["_RegIDWalletName"].ToString();
                    _res.PackageWalletName = dt.Rows[0]["_PackageWalletName"] is DBNull ? string.Empty : dt.Rows[0]["_PackageWalletName"].ToString();
                }
            }
            catch (Exception ex)
            {
