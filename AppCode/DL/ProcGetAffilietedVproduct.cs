...
{
    public class ProcGetAffilietedVproduct : IProcedure
    {
        private readonly IDAL _dal;
        public ProcGetAffilietedVproduct(IDAL dal) => _dal = dal;
        ...
        public object Call(object obj)
        {
            ...
            SqlParameter[] param = {
                ...
                new SqlParameter("@VID",req.CommonInt3),
        ...
        public string GetName() => "proc_GetAllvproduct";
    }
}
