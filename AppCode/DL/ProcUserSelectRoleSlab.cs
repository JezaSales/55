...
namespace RoundpayFinTech.AppCode.DL
{
    ...
    public class ProcUserSelectRoleSlabB2cTarget : IProcedure
    {
        private readonly IDAL _dal;
        public ProcUserSelectRoleSlabB2cTarget(IDAL dal) => _dal = dal;
        public object Call(object obj)
        {
            int UserID = (int)obj;
            SqlParameter[] param = {
        ...
        public string GetName() => "proc_User_SelectRoleSlabB2cTarget";
    }
