...
namespace RoundpayFinTech.AppCode.DL
{
    ...
    public class ProcGetB2cTargetServices : IProcedure
    {
        private readonly IDAL _dal;
        public ProcGetB2cTargetServices(IDAL dal) => _dal = dal;
        public object Call(object obj)
        {
            throw new NotImplementedException();
        }
        ...
        public string GetName() => "select _ID,_Name,_SCode,_WalletTypeID,_IsVisible from MASTER_SERVICE where _IsDeleted=0 and _InTarget=1 and _IsActive=1 order by _Ind";
        public int GetServiceID(int ID)
        {
            SqlParameter[] param = {
             new SqlParameter("@ID",ID)
