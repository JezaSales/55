...
namespace RoundpayFinTech.AppCode.Interfaces
{
    ...
    public interface IReportML
    {
        ...
        HLRResponseStatus HitHLRAPIs(string ApiCode, string URL, int ApiId, int UserId, string MobNo, string APIOpCode);
        ...
        IResponseStatus ProcTogglePG(int ID);
        Task<PaymentGatewayEntity> GetPaymentGateway(CommonReq filter);
