...
namespace RoundpayFinTech.AppCode.Interfaces
{
    public interface IMembershipML
    {
        ...
        IResponseStatus ChangeMemberShipStatus(int ID, string type);
        IResponseStatus ChangeCouponAllowedStatus(int ID);
        PackageDetailB2CWithMemberShip GetB2CMemberShipType(int LoginID);
        ...
        Task<IEnumerable<B2cTarget>> GetB2cTargetAchieved(CommonReq commonReq);
    }
}
