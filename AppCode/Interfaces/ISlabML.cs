...
namespace RoundpayFinTech.AppCode.Interfaces
{
    public interface ISlabML
    {
        ...
        SlabDetailModel GetB2cSlabDetail(int SlabID, int OpTypeID);
        SlabDetailModel GetSlabDetailGI(int SlabID, int OpTypeID);
        IResponseStatus UpdateSlabDetail(SlabCommission slabCommission, string slabType = "G");
        ...
        Task<List<SlabdetailServicewise>> GetSlabdetailServicewise(int slabId);
        IResponseStatus B2CdislaycommissionUpdate(SlabdetailServicewise AddData);
        ResponseStatus BBPSServiceRouteSave(int sr, int srp);
        Serviceroute BBPSServiceRoute();
    }
}
