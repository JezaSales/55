...
namespace RoundpayFinTech.AppCode.Interfaces
{
    ...
    { 
        ...
        IEnumerable<CoupanVoucher> GetCouponVoucher(int Id, int loginId, int loginTypeId);
        ...
        Task<IEnumerable<CouponstockDetail>> GetCouponStock(CoupanVoucherReq req);
        IEnumerable<VStock> GetVoucherStock( string APIID);
    }
}
