...
namespace RoundpayFinTech.AppCode.Interfaces
{
    public interface IOperatorML
    {
        ...
        IEnumerable<OpTypeMaster> GeB2CtOptypeInSlab();
        ...
        //IResponseStatus UpdateB2Cdislaycommission(SlabdetailServicewise rangeDetail);
        ...
        IEnumerable<ServiceMaster> GetB2cTargetServices();
    }
    public interface ITargetML
    {
        TargetModel GetTargetB2c(TargetModel DetailReq);
        ...
        IResponseStatus SaveTargetB2c(TargetModel rangeDetail);
