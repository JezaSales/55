...
namespace RoundpayFinTech.Controllers
{
    ...
    public class AEPSController : Controller
    {
        ...
        public async Task<IActionResult> MosambeeStatusCheck()
        {
            ...
            if (mosambeeResp.transactionTypeId.ToString().In("36", "7"))
                mBnkReq.APIOpCode = mosambeeResp.creditDebitCardType;
            else if (mosambeeResp.transactionTypeId.ToString().In("39"))
                mBnkReq.APIOpCode = mosambeeResp.transactionTypeName.Replace(" ", "");
            else
