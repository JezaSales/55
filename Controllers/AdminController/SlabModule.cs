...
namespace RoundpayFinTech.Controllers
{
    public partial class AdminController
    {
        ...
        [HttpPost("RSlabDetail")]
        public IActionResult RSlabDetail(SlabCommission slabCommission, string slabType = "")
        {
            ISlabML slabML = new SlabML(_accessor, _env);
            IResponseStatus _resp = slabML.UpdateSlabDetail(slabCommission, slabType);
            return Json(_resp);
        }

        [HttpPost("MLM_RSlabDetail")]
        ...
        [HttpPost]
        [Route("/B2Cdislaycommission")]
        public async Task<IActionResult> B2Cdislaycommission(int slabId)
        {
            if (!ApplicationSetting.IsB2CEnabled)
                return Forbid();
            ISlabML slabML = new SlabML(_accessor, _env);
            var slabDetailModel = await slabML.GetSlabdetailServicewise(slabId);
            return PartialView("Partial/_B2Cdislaycommission", slabDetailModel);
        }

        [HttpPost]
        [Route("Home/UpdateB2Cdislaycommission")]
        [Route("UpdateB2Cdislaycommission")]
        public IActionResult UpdateB2Cdislaycommission(SlabdetailServicewise AddData)
        {
            ISlabML ml = new SlabML(_accessor, _env);
            var resp = ml.B2CdislaycommissionUpdate(AddData);
            return Json(resp);
        ...
        //[HttpPost]
        //[Route("Home/B2Cdislaycommission")]
        //[Route("B2Cdislaycommission")]
        //public IActionResult _B2Cdislaycommission()
        //{
        //    return PartialView("Partial/_B2Cdislaycommission");
        //}
    }
}
//_B2Cdislaycommission