...
namespace RoundpayFinTech.Controllers
{
    public partial class AdminController
    {
        ...
        [HttpPost("change-backup-api")]
        public IActionResult ChangeBackupAPI(APISwitched aPISwitched)
        {
            ISwitchingML sml = new SwitchingML(_accessor, _env);
        ...
        [HttpPost]
        public async Task<IActionResult> APIs(int opTypeId ,string action)
        {
