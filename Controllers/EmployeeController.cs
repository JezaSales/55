...
namespace RoundpayFinTech.Controllers
{
    ...
    public class EmployeeController : Controller
    {
        ...
        [HttpPost("Employee/_LeadDetail")]
        public async Task<IActionResult> _LeadDetail(int TopRows, string Request, string MobileNo, string AssignDate, string AssignDateTo, int OnlyTodayFollowup)
        {
            IEmpML ml = new EmpML(_accessor, _env);
            var _req = new CommonReq
            {
                ...
                CommonStr4 = AssignDateTo,
                CommonInt2 = OnlyTodayFollowup
            };
